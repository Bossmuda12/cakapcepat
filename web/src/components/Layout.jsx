...
const NAV_ITEMS = [
  ...
  { to: "/orders-list", label: "Pesanan", icon: "M9 2h6l1 4H8l1-4ZM4 6h16l-1.5 14a2 2 0 0 1-2 1.8H7.5a2 2 0 0 1-2-1.8L4 6ZM9 11h6M9 15h6" },
  { to: "/courier", label: "Kurir", icon: "M1 3h15v13H1V3ZM16 8h4l3 3v5h-7V8ZM3 18.5a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0 -5 0ZM16 18.5a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0 -5 0Z" },
  ...
  { to: "/automation", label: "Otomatisasi AI", icon: "M13 2 3 14h7l-1 8 10-12h-7l1-8Z" },
